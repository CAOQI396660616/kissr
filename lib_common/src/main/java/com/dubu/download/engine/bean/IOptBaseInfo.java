...
public interface IOptBaseInfo {
     ...
     */
    String getCoverOptPath();

    /**
     * 设置资源封面路径，包含本地和网络
     * Set the info cover path
     */
    void setCoverOptPath(String coverOptPath);
     ...
     */
    void setCommonOptInfo(String info);

    /**
     * 获取公用字符串类型信息
     * Gets the info common string
     */
    String getCommonOptInfo();
     ...
     * Update info
     */
    void update(IOptBaseInfo newInfo);

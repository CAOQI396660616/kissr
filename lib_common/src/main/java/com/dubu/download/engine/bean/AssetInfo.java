 ...
 * 资源信息实体类，和网络资源具有对应关系
 */
public class AssetInfo extends BaseOptInfo {

    //allen 新增 我们下载背景音乐类型
    public static final int ASSET_AI_MUSIC_BG = 10001;
    public static final int ASSET_AI_USER_VIDEO = 10002;

    public static final int ASSET_AI_USER_IMAGE = 10003;
    ...
    public String toString() {
        return "AssetInfo{id=" + id  + ",packageId=" + getPackageId()+ ",name=" + getName() + ",version=" + getVersion()
                + ",localVersion=" + getLocalVersion() + ",type=" + getType() + ",hadDownload=" + hadDownloaded + "}";
    }

    public static AssetInfo create(AssetOptList.NvOptAssetInfo info, int type) {
        AssetInfo assetInfo = new AssetInfo();
        assetInfo.setId(info.id);
        assetInfo.setPackageId(info.id);
        assetInfo.setEffectMode(BaseOptInfo.EFFECT_MODE_OptPACKAGE);
        ...
        assetInfo.setCoverOptPath(info.coverUrl);
        ...
        assetInfo.setOptAuthorized(info.authed);

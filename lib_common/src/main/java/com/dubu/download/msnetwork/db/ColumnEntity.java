 ...
 */
package com.dubu.download.msnetwork.db;
 ...
 * ================================================
 * 列的实体类
 * The entity class of the column
 */
public class ColumnEntity {

    public String columnName;               //列的名字 The name of the column
    public String columnType;               //列的类型 The type of the column
    public String[] compositePrimaryKey;    //复合主键 Composite Primary Key
    public boolean isPrimary;               //是否是主键 isId true
    public boolean isNotNull;               //是否不能为空 Can't be empty

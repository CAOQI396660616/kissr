 ...
 */
package com.dubu.download.msnetwork.exception;
...
public class HttpException extends RuntimeException {
    ...
    /**
     * Net error http exception.
     * http异常 单独返回404错误 处理 allen
     * @return the http exception
     */
    public static HttpException NET_ERROR_404() {
        HttpException httpException = new HttpException("network error! http response code is 404");

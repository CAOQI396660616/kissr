 ...
 */
package com.dubu.download.msnetwork.callback;

import android.graphics.Bitmap;
import android.widget.ImageView;

import com.dubu.download.msnetwork.convert.BitmapConvert;
 ...
 * Back to the Bitmap of the image, there is no zooming in the image, it may happen OOM
 * 修订历史：
 * ================================================
 */

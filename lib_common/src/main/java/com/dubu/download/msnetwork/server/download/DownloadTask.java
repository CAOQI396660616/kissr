 ...
 */
package com.dubu.download.msnetwork.server.download;

import android.content.ContentValues;
import android.text.TextUtils;

import com.dubu.download.msnetwork.db.DownloadManager;
import com.dubu.download.msnetwork.exception.HttpException;
import com.dubu.download.msnetwork.exception.OkGoException;
import com.dubu.download.msnetwork.exception.StorageException;
...
import com.dubu.download.msnetwork.server.task.PriorityRunnable;
import com.dubu.download.msnetwork.utils.HttpUtils;
import com.dubu.download.msnetwork.utils.IOUtils;
...
public class DownloadTask implements Runnable {
    ...
    public void run() {
        ...
        //allen 为了解决后台图片404 单独处理404 error
        if (code == 404) {
            postOnError(progress, HttpException.NET_ERROR_404());
            return;
        }

...
public class PagerLayoutManagerOld extends LinearLayoutManager {
    ...
    public PagerLayoutManagerOld(Context context) {
        super(context);
        init();
    }

    public PagerLayoutManagerOld(Context context, int orientation) {
        super(context, orientation, false);
        init();
    }

    public PagerLayoutManagerOld(Context context, int orientation, boolean reverseLayout) {

 ...
 */
@Suppress("unused")
class CancelSureDialog : DialogFragment() {
    ...
    fun withTitle(title: String): CancelSureDialog {
        this.title = title
        return this
    }


    fun withContent(content: String): CancelSureDialog {
        this.content = content
        return this
    }

    fun withContentSpannableString(content: SpannableString): CancelSureDialog {
        this.contentSP = content
        return this
    }

    fun withStartText(txt: String): CancelSureDialog {
        this.startText = txt
        return this
    }

    fun withEndText(txt: String): CancelSureDialog {
        this.endText = txt
        return this
    }

    fun withTitle(title: Int): CancelSureDialog {
        this.title = BaseApp.instance.getString(title)
        return this
    }

    fun withContent(content: Int): CancelSureDialog {
        this.content = BaseApp.instance.getString(content)
        return this
    }

    fun withStartText(txt: Int): CancelSureDialog {
        this.startText = BaseApp.instance.getString(txt)
        return this
    }

    fun withEndText(txt: Int): CancelSureDialog {
        this.endText = BaseApp.instance.getString(txt)
        return this
    }

    fun withEndColor(color: Int): CancelSureDialog {
        this.endColor = color
        return this
    }

    fun withStartColor(color: Int): CancelSureDialog {
        this.startColor = color
        return this
    }

    fun withStartListener(action: () -> Unit): CancelSureDialog {
        startListener = action
        return this
    }


    fun withEndListener(action: () -> Unit): CancelSureDialog {
        endListener = action
        return this
    }

    fun withCancelOnBack(cancel: Boolean): CancelSureDialog {
        canCancel = cancel
        return this
    }

    fun withCancelOutside(cancelOutside: Boolean): CancelSureDialog {
        this.cancelOutside = cancelOutside
        return this
    }

    fun withContentCenter(contentCenter: Boolean): CancelSureDialog {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.dialog_c_s, container, false)
        initView(root)
        return root
    }

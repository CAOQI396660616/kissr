 ...
 */
public final class EncryptFactory extends Converter.Factory {
    /**
     * Create an instance using a default {@link Moshi} instance for conversion.
     */
    public static EncryptFactory create() {
    ...
    public static EncryptFactory create(Moshi moshi) {
        return new EncryptFactory(moshi, false, false, false);
    }
     ...
     */
    public EncryptFactory asLenient() {
        return new EncryptFactory(moshi, true, failOnUnknown, serializeNulls);
    }

    /**
     * Return a new factory which uses {@link JsonAdapter#failOnUnknown()} adapters.
     */
    public EncryptFactory failOnUnknown() {
        return new EncryptFactory(moshi, lenient, true, serializeNulls);
    }

    /**
     * Return a new factory which includes null values into the serialized JSON.
     */
    public EncryptFactory withNullSerialization() {
        return new EncryptFactory(moshi, lenient, failOnUnknown, true);
    }
    ...
    public Converter<ResponseBody, ?> responseBodyConverter(
        ...
        return new DecryptResponseConverter<>(adapter,type);
    }
    ...
    public Converter<?, RequestBody> requestBodyConverter(
        ...
        return new EncryptRequestConverter<>(adapter);
    }

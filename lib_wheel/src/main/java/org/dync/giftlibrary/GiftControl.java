 ...
 * https://github.com/DyncKathline/LiveGiftLayout
 */
...
//
//                    /*
//                    * //TODO CQ 这里修改了源码的逻辑 源码是每一个view 播放完动画就移除 会造成第二个view上移 所以是在所有的view全部做完动画以后才移除
//                    *   但是这样 是稍微有点慢的  本来第一个移除了 之后的就可以添加 最好的逻辑是修改布局 移除 第一个 第二个不会上移
//                    *   小问题之后有时间优化
//                    * */
//
//                    if(index +1 == mGiftLayoutMaxNums && index +1 == mGiftLayoutParent.getChildCount()){

...
public class CustormAnim implements ICustormAnim {
    ...
    public AnimatorSet startAnim(final GiftFrameLayout giftFrameLayout, View rootView) {
        //礼物飞入
        ObjectAnimator flyFromLtoR2 = GiftAnimationUtil.createFlyFromLtoR(giftFrameLayout, -500, 12, 200, new AccelerateInterpolator());
    ...
    public AnimatorSet comboAnim(final GiftFrameLayout giftFrameLayout, View rootView, boolean isFirst) {
        final TextView anim_num = (TextView) rootView.findViewById(R.id.animation_num);
        if (isFirst) {
    ...
    public AnimatorSet endAnim(final GiftFrameLayout giftFrameLayout, View rootView) {
        //向上渐变消失
        ObjectAnimator fadeAnimator = GiftAnimationUtil.createFadeAnimator(giftFrameLayout, 200, 0);
        // 复原
        ObjectAnimator fadeAnimator2 = GiftAnimationUtil.createFadeAnimator(giftFrameLayout, 0, 0);
